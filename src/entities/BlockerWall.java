...
public class BlockerWall extends Entity {
    ...
    public BlockerWall(int x, int y) {
        super(x, y, EntityTypeData.WALL_DRAW_WIDTH, EntityTypeData.WALL_DRAW_HEIGHT, 
              WALL_HEALTH, 0, 0, 0);
        setSprite("obstacles/wall.png");
    }

    @Override protected void move() { }
    @Override protected boolean canAttack() { return false; }
    @Override protected void attack() { }
    @Override protected Color getColor() { return Color.GRAY; } 

    public int getCost() { return WALL_COST; }
    ...
    protected void drawHealthBar(Graphics g) {
        ...
        g.fillRect(barX, barY, Math.max(0, fillWidth), barHeight);
